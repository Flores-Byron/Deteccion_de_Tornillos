...
bash
git clone https://github.com/Flores-Byron/Deteccion_de_Tornillos.git
cd Deteccion_de_Tornillos
...
# Problema:
¿Cómo implementar un sistema de visión artificial que detecte placas de coches en tiempo real, con alta precisión y bajo costo?
